...
/**
 * @title PTAaveLooper
 * @notice Aave V3 looper using Pendle PT tokens as collateral.
 ...
 *         - Uses Aave V3 market with PT as collateral
 * @dev Example: Use PT-sUSDe as collateral, borrow USDC, swap to sUSDe, buy PT, repeat.
 */
contract PTAaveLooper is BaseAaveLooper, PendleSwapper {
    ...
    {
        // Higher default leverage for PT strategies (fixed income nature)
