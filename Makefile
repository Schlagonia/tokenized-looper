...
EXCLUDED_TEST_PATHS := src/test/{aave/susde-usdc,aave/syrup-usdt,euler,morpho/syrup-arb}/**/*.t.sol
...
trace-path  :; forge test -vvv --match-path $(PATH_GLOB) --fork-url ${FORK_URL}
